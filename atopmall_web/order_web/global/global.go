...
import (
	...
	"atopmall_web/order_web/config"
	"atopmall_web/order_web/proto"
)

// 聚合订单服务所有子服务客户端
type OrderRpcClient struct {
	Order        proto.OrderClient
	ShoppingCart proto.ShoppingCartClient
}
...
var (
	...
	OrderSrvCli     *OrderRpcClient     = &OrderRpcClient{}
...
/*
	...
	5. OrderSrvCli: 订单服务客户端（含订单、购物车服务） 用于调用所有订单相关服务的接口
	6. GoodsSrvCli: 商品服务客户端 用于调用所有商品相关服务的接口
	7. InventorySrvCli: 库存服务客户端 用于调用所有库存相关服务的接口
*/
