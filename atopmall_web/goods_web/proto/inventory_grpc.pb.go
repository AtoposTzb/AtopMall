...
type InventoryClient interface {
	...
	RebackInv(ctx context.Context, in *SellInfo, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *inventoryClient) RebackInv(ctx context.Context, in *SellInfo, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
type InventoryServer interface {
	...
	RebackInv(context.Context, *SellInfo) (*emptypb.Empty, error)
...
func (UnimplementedInventoryServer) SellInv(context.Context, *SellInfo) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method SellInv not implemented")
}
func (UnimplementedInventoryServer) RebackInv(context.Context, *SellInfo) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method RebackInv not implemented")
}
...
func _Inventory_RebackInv_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InventoryServer).RebackInv(ctx, req.(*SellInfo))
	}
	return interceptor(ctx, in, info, handler)
}
